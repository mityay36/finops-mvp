...
class OnPremTCOConfig(Base):
    ...
    colocation_monthly: Mapped[Decimal] = mapped_column(Numeric(14, 2), nullable=False, default=0, server_default="0")
    ...
    cpu_to_ram_cost_ratio: Mapped[Decimal] = mapped_column(Numeric(4, 2), nullable=False, default=Decimal("0.70"), server_default="0.70")
